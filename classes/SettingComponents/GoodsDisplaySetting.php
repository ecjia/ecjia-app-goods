...
class GoodsDisplaySetting extends ComponentAbstract
{
    ...
    public function handle()
    {
        $data = [
            ...
            ['code' => 'hot_number', 'value' => '', 'options' => ['type' => 'text']],
            ['code' => 'promote_number', 'value' => '', 'options' => ['type' => 'text']],
            ['code' => 'group_goods_number', 'value' => '', 'options' => ['type' => 'text']],
            ['code' => 'top_number', 'value' => '', 'options' => ['type' => 'text']],
