...
// 			}
		...
		if (!empty($data)) {
			...
			foreach ($data as $key => $row) {
				...
				$arr[$key]['shop_price']	= $row['shop_price'] > 0 ? price_format($row['shop_price']) : __('免费');
