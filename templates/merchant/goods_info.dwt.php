                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="{$form_action}" method="post" name="theForm">
                        ...
                        <div class="col-lg-5 pull-right">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group m_b0">
                                                <label class="control-label {if $goods.goods_id}col-lg-5{else}col-lg-6{/if}">
                                                    ...
                                                    {/if}
                                                    <input type="hidden" name="extension_code" value="{$goods.extension_code}" />
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <a data-toggle="collapse" data-parent="#accordionTwo" href="#collapseFour" class="accordion-toggle">
                                            <span class="glyphicon"></span>
                                            <h4 class="panel-title">{t domain="goods"}所属平台分类{/t}</h4>
                                        </a>
                                    </div>
                                    <div id="collapseFour" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <div class="form-group p_l15 m_b10">
                                                <label>{t domain="goods"}平台分类：{/t}</label>{$cat_html}<br/>
                                                {if $goods.goods_id}
                                            ...
                                            <div class="form-group p_l15 p_r15 m_b0">
                                                <label>{t domain="goods"}选择扩展分类{/t}</label>
                                                <span class="input-must m_l10">*</span>
                                                <div class="goods-cat" style="width: auto">
                                                    <div class="goods-span">
                                                        <!-- {foreach from=$cat_list item=cat} -->
                                                        <label style="padding-left:{$cat.level * 20}px;display: block; font-weight: normal" class="cat_{$cat.cat_id}" >
                                                            <input type="checkbox" name="other_cat[]" style="display: inline-block;" value="{$cat.cat_id}" {if $cat.is_other_cat}checked="checked"{/if}/>
                            ...
                            <div class="panel-group">
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <a data-toggle="collapse" data-parent="#accordionTwo" href="#collapseFour2" class="accordion-toggle">
                                            <span class="glyphicon"></span>
                                            <h4 class="panel-title">{t domain="goods"}所属店铺分类{/t}</h4>
                                        </a>
                                    </div>
