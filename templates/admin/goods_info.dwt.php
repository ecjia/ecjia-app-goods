												...
												<div class="accordion-inner">
													<div class="control-group control-group-small" >
														...
														<div class="controls">
															...
															<br />
															<p class="help-block w280 m_t5">{lang key='goods::goods.notice_keywords'}</p>
														</div>
													</div>
													<div class="control-group control-group-small" >
														...
														<tbody class="term_meta_edit" data-id="{$goods.goods_id}" data-extension-code="{$code}" data-active="{url path='goods/admin/update_term_meta'}">
															...
															<tr>
																<td>
																	...
																	<a class="data-pjax btn m_t5" data-toggle="edit_term_meta" href="javascript:;">{lang key='goods::goods.update'}</a>
																	<a class="ajaxremove btn btn-danger m_t5" data-toggle="ajaxremove" data-msg="{lang key='goods::category.remove_custom_confirm'}" href='{url path="goods/admin/remove_term_meta" args="meta_id={$term_meta.meta_id}"}'>{lang key='system::system.drop'}</a>
																</td>
													...
													<div class="control-group control-group-small">
														...
														<div class="f_l m_l30">
															<div class="goods-span">
																...
																<!-- {/foreach} -->
																<p class="help-block w280 m_t5" id="noticeUserPrice">{lang key='goods::goods.notice_user_price'}</p>
															</div>
														</div>
													</div>
													<!-- {/if} -->
