	...
	<div class="choose_list">
		<div class="btn-group f_l m_r5">
			...
			<ul class="dropdown-menu batch-move" data-url="{RC_Uri::url('goods/admin/batch')}">
				...
				<li><a class="batch-trash-btn" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url="{$form_action}&type=pass&is_on_sale={$goods_list.filter.is_on_sale}&page={$smarty.get.page}" data-msg="您确定要审核通过选中的商品吗？" data-noSelectMsg="请选择需要修改审核状态的商品" href="javascript:;"> <i class="fontello-icon-box"></i>审核通过</a></li>
				<li><a class="batch-trash-btn" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url="{$form_action}&type=not_pass&is_on_sale={$goods_list.filter.is_on_sale}&page={$smarty.get.page}" data-msg="您确定要不审核通过选中的商品吗？" data-noSelectMsg="请选择需要修改审核状态的商品" href="javascript:;"> <i class="fontello-icon-box"></i>审核未通过</a></li>
				<li><a class="batch-trash-btn" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url="{$form_action}&type=not_audited&is_on_sale={$goods_list.filter.is_on_sale}&page={$smarty.get.page}" data-msg="您确定要将选中的商品设为未审核吗？" data-noSelectMsg="请选择需要修改审核状态的商品" href="javascript:;"> <i class="fontello-icon-box"></i>设为未审核</a></li>
				<li><a class="batch-trash-btn" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url="{$form_action}&type=not_check&is_on_sale={$goods_list.filter.is_on_sale}&page={$smarty.get.page}" data-msg="您确定要将选中的商品设为无需审核吗？" data-noSelectMsg="请选择需要修改审核状态的商品" href="javascript:;"> <i class="fontello-icon-box"></i>无需审核</a></li>
			</ul>
		</div>
