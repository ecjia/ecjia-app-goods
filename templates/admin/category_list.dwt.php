...
<script type="text/javascript">
	ecjia.admin.goods_category_list.init();
</script>
<!-- {/block} -->
	...
	<table class="table table-striped" id="list-table">
		<thead>
			<tr>
				...
				<th class="w100">{t domain="goods"}商品数量{/t}</th>
				<th class="w100">{t domain="goods"}数量单位{/t}</th>
				<th class="w100">{t domain="goods"}价格分级{/t}</th>
				<th class="w50">{t domain="goods"}排序{/t}</th>
				<th class="w100">{t domain="goods"}是否显示{/t}</th>
