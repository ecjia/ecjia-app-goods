	...
	<table class="table table-striped"  id="list-table">
		<thead>
			<tr>
				...
				<th class="w100">{lang key='goods::category.goods_number'}</th>
				<th class="w100">{lang key='goods::category.measure_unit'}</th>
				<th class="w100">{lang key='goods::category.short_grade'}</th>
				<th class="w50">{lang key='goods::category.sort_order'}</th>
				<th class="w100">{lang key='goods::category.is_show'}</th>
