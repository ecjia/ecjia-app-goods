...
<div class="row-fluid">
	<table class="table table-striped"  id="list-table">
		...
		<tr class="{$cat.level}" id="{$cat.level}_{$cat.cat_id}">
			...
			<td> 
				<span class="cursor_pointer" data-trigger="editable" data-url="{url path='goods/admin_category/edit_grade'}" data-name="edit_grade" data-pk="{$cat.cat_id}" data-title="请输入价格分级"> 
					<!-- {$cat.grade} -->
				</span>
			</td>
			<td>
