								...
								<div class="ms-selection">
									...
									<ul class="ms-list nav-list-content">
										...
										<li class="ms-elem-selection">
											...
											<span class="link_static m_r5">{if $link_good.is_double}[双向关联]{else}[单向关联]{/if}</span><!-- {$link_good.goods_name} -->
											<span class="edit-list"><a class="change_links_mod" href="javascript:;">切换关联</a><i class="fontello-icon-minus-circled ecjiafc-red del"></i></span>
										</li>
										<!-- {/foreach} -->
									</ul>
								</div>
