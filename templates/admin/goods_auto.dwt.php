			...
			<table class="table table-striped smpl_tbl">
				<thead>
					<tr>
					  	...
					  	<th class="w70">{lang key='goods::goods_auto.id'}</th>
					  	<th>{lang key='goods::goods_auto.goods_name'}</th>
					  	<th class="w180">{lang key='goods::goods_auto.starttime'}</th>
					  	<th class="w180">{lang key='goods::goods_auto.endtime'}</th>
