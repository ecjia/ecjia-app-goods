...
function get_merchant_goods_info_nav($goods_id=0, $action_type, $extension_code = '') {
	return array(
		...
		'edit_goods_parameter'       => array('name' => __('商品参数', 'goods'), 'pjax' => 1, 'href' => RC_Uri::url('goods/merchant/edit_goods_parameter', "goods_id=$goods_id&action_type=$action_type".$extension_code)),
		'edit_goods_specification'   => array('name' => __('规格/货品', 'goods'), 'pjax' => 1, 'href' => RC_Uri::url('goods/merchant/edit_goods_specification', "goods_id=$goods_id&action_type=$action_type".$extension_code)),
		'edit_goods_photo'           => array('name' => __('商品相册', 'goods'), 'pjax' => 1, 'href' => RC_Uri::url('goods/mh_gallery/init', "goods_id=$goods_id&action_type=$action_type".$extension_code)),
