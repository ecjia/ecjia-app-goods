...
//		}
   ...
   /**
	...
	public function clear_spec_data() {
		...
		if($count > 0) {
			return $this->showmessage(__('该规格模板下的货品以及产品了订单交易，不可以更改规格模板', 'goods'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_ERROR);
		} else {
 			//清除商品关联的模板id为0
		    ...
		    return $this->showmessage(__('清除相关数据成功，您可以重新进行更换规格模板', 'goods'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS);
		}
	}
