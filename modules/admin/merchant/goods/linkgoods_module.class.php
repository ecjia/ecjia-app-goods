 ...
 *
 */
class admin_merchant_goods_linkgoods_module extends api_admin implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
		...
		$goods_linkgoods = Ecjia\App\Goods\Models\LinkGoodsModel::where('goods_id', $goods_id)->get();
