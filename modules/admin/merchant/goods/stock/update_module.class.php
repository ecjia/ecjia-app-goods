...
/**
 * 快速修改商品库存（单独修改商品goods_number）
 * @author zrl
 *
 */
class admin_merchant_goods_stock_update_module extends api_admin implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
        ...
        Ecjia\App\Goods\Models\GoodsModel::where('goods_id', $goods_id)->where('store_id', $_SESSION['store_id'])->update(array('goods_number' => $number));
