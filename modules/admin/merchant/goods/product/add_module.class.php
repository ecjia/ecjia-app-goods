 ...
 *
 */
class admin_merchant_goods_product_add_module extends api_admin implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
    	...
    	$goods_attr_ids_string = implode('|', $goods_attr_ids);
    	
    	if(Ecjia\App\Goods\MerchantGoodsAttr::check_goods_attr_exist($goods_attr_ids_string, $goods_id)) {
    		return new ecjia_error('goods_attr_ids_exist', __('所匹配的属性已存在相应的货品,请更换组合', 'goods'));
    	}
    	
    	$data = array(
    			'goods_id' 		=> $goods_id,
    			'goods_attr'	=> $goods_attr_ids_string,
    	...
    	if ($product_sn) {
    		...
    		return new ecjia_error('add_product_fail', __('添加货品失败', 'goods'));
    	}
    }
}
