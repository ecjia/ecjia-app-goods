...
class goods_merchant_menu_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        ...
        $submenus = array(
            ...
            ecjia_merchant::make_admin_menu('divider', '', '', 11)->add_purview(array('goods_type', 'merchant_category_manage')),
            ...
            ecjia_merchant::make_admin_menu('13_goods_spec_template', __('商品规格', 'goods'), RC_Uri::url('goods/mh_spec/init'), 13)->add_purview('goods_spec_template_manage')->add_icon('fa-delicious'),
        	ecjia_merchant::make_admin_menu('14_goods_parameter_template', __('商品参数', 'goods'), RC_Uri::url('goods/mh_parameter/init'), 14)->add_purview('goods_parameter_template_manage')->add_icon('fa-thumb-tack'),
        );
