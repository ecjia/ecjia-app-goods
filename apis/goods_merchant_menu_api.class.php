...
class goods_merchant_menu_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        ...
        $submenus = array(
            ...
            ecjia_merchant::make_admin_menu('01_goods_add', __('添加新商品'), RC_Uri::url('goods/merchant/add'), 11)->add_purview('goods_update')->add_icon('fa-plus-square-o'), //array('goods_update')

            ecjia_merchant::make_admin_menu('divider', '', '', 20)->add_purview(array('goods_type', 'merchant_category_manage')),
            ecjia_merchant::make_admin_menu('04_category_list', __('商品分类'), RC_Uri::url('goods/mh_category/init'), 21)->add_purview('merchant_category_manage')->add_icon('fa-th-list'), //array('merchant_category_manage')
            ecjia_merchant::make_admin_menu('05_goods_type', __('商品规格'), RC_Uri::url('goods/mh_spec/init'), 22)->add_purview('goods_type')->add_icon('fa-navicon'), //'attr_manage'
        );
