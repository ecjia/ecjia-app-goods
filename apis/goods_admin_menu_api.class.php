...
class goods_admin_menu_api extends Component_Event_Api {
	public function call(&$options) {
		...
		$submenus = array(
			...
			ecjia_admin::make_admin_menu('01_goods_list', __('在售商品', 'goods'), RC_Uri::url('goods/admin/init', array('action' => 'sale')), 1)->add_purview(array('goods_manage')),
			ecjia_admin::make_admin_menu('02_goods_list', __('售罄商品', 'goods'), RC_Uri::url('goods/admin/init', array('action' => 'finish')), 2)->add_purview(array('goods_manage')),
			ecjia_admin::make_admin_menu('03_goods_list', __('下架商品', 'goods'), RC_Uri::url('goods/admin/init', array('action' => 'obtained')), 3)->add_purview(array('goods_manage')),
			ecjia_admin::make_admin_menu('04_goods_list', __('审核商品', 'goods'), RC_Uri::url('goods/admin/init', array('action' => 'check')), 4)->add_purview(array('goods_manage')),
